...
public class WepHandler {
    ...
    public Map<String, Object> handle(Map<String, Object> request, Jwt jwt, Context context) {
        ...
        Map<String, Object> http = JsonUtils.getNestedMap(request, "requestContext", "http");
        Map<String, Object> headers = JsonUtils.getNestedMap(request,  "headers");
        ...
        response.put("queryStringParameters", request.get("queryStringParameters"));
